const GallerySection = () => {
  const rules = [
    ...
    {
      title: "Процестің сапасы үшін",
      description: "тыныш жерде, камера қосулы, микрофон керек кезінде қосып, құлаққаппен қосылғаныңыз маңызды. *бұл өзіңізбен жұмысты тереңдетуге мүмкіндік береді.",
      icon: "💬",
    },
  ];
