...
const results = [
  ...
  { percent: "56%", status: "Жоғары", label: "Қабылданбау", color: "#f59552" },
  { percent: "62%", status: "Жоғары", label: "Сынық", color: "#25b9a3" },
  { percent: "100%", status: "Төмен", label: "Дәрменсіздік", color: "#d94743" },
  { percent: "64%", status: "Төмен", label: "Сәтсіздік", color: "#f48b2f" },
  { percent: "100%", status: "Өте жоғары", label: "Басқаруға еру", color: "#e84436" },
  { percent: "64%", status: "Төмен", label: "Болжам", color: "#2db6aa" },
  { percent: "80%", status: "Өте жоғары", label: "Өзін құрбан ету", color: "#d94743" },
  { percent: "100%", status: "Өте жоғары", label: "Бағыну", color: "#e84436" },
  { percent: "64%", status: "Төмен", label: "Эмоцияны ұстау", color: "#f48b2f" },
  ...
  { percent: "100%", status: "Өте жоғары", label: "Перфекционизм", color: "#e84436" },
  { percent: "84%", status: "Өте жоғары", label: "Дисциплина жоқтығы", color: "#f5822e" },
  { percent: "12%", status: "Төмен", label: "Менмендік", color: "#2bbf63" },
];
