...
const TariffsSection = () => {
  ...
  return (
    <section id="tariff" className="py-16 md:py-24 px-6 lg:px-16 bg-muted relative overflow-hidden">
      ...
      <h2 className="relative font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-12 md:mb-16 text-center animate-rise-bloom">
        Тренинг <span className="text-primary">бағасы</span>
      </h2>

      <div className="max-w-md mx-auto">
        <div className="relative bg-primary text-primary-foreground rounded-3xl p-8 md:p-10 text-center animate-pop-glow hover:scale-[1.02] transition-transform duration-300 animate-swipe-right-strong" style={{ animationDelay: '0.1s' }}>
          ...
          <ul className="space-y-4 mb-10 text-left animate-swipe-left-strong" style={{ animationDelay: '0.2s' }}>
            {tariff.features.map((feature, idx) => (
              <li key={idx} className="flex items-start gap-3 animate-rise-bloom" style={{ animationDelay: `${idx * 0.08 + 0.25}s` }}>
