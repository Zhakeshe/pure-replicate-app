...
export const AUTHENTICITY_LOGO_FILTER =
  "brightness(0) saturate(100%) invert(8%) sepia(82%) saturate(3674%) hue-rotate(340deg) brightness(75%) contrast(112%)";
...
export const SPEAKER_IMAGE_URL =
  "https://fotohosting.pro/i/1W6A6693-resized-%281%29-no-bg-HD-%28carve.photos%29.kxdXX";
